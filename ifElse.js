...
// Tasks:
// 1. Declare a variable called "temperature" and assign it a numeric value representing the current 
// temperature.
// 2. Write an if-else statement to check if the temperature is greater than or equal to 30 degrees 
// Celsius.
...
// 3. Declare a variable called "isRaining" and assign it a boolean value (true or false) indicating if 
// it's raining or not.
...
// 5. Declare a variable called "time" and assign it a numeric value representing the current hour of 
// the day (in 24-hour format).
...
//  - If the time is between 12 PM and 6 PM (inclusive), print "Good afternoon!" using 
// console.log().
...
// Assignment-4 : if-Else Practice (Solutions)
...
// 3. Declare a variable called "isRaining" and assign it a boolean value indicating if it's raining or not.
var isRaining = true;
...
// Code Written By
// Name    :Developer Sajid
// Number  : +88 01608-95 88 87